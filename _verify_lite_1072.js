...
function serve() {
  return new Promise(res => {
    const s = http.createServer((req, rq) => {
      let p = decodeURIComponent(req.url.split('?')[0]); if (p === '/') p = '/lite-1.072.html';
...
(async () => {
  ...
  await pgS.goto(`http://localhost:${port}/lite-1.072.html`, { waitUntil: 'domcontentloaded' });
  ...
  await pg2.goto(`http://localhost:${port}/lite-1.072.html`, { waitUntil: 'domcontentloaded' });
  ...
  await pg3.goto(`http://localhost:${port}/lite-1.072.html`, { waitUntil: 'domcontentloaded' });
  ...
  await pg4.goto(`http://localhost:${port}/lite-1.072.html`, { waitUntil: 'domcontentloaded' });
  ...
  await pg5.goto(`http://localhost:${port}/lite-1.072.html`, { waitUntil: 'domcontentloaded' });
  ...
  await pg6.goto(`http://localhost:${port}/lite-1.072.html?share=ZZZ`, { waitUntil: 'domcontentloaded' });
  ...
  await pg6m.goto(`http://localhost:${port}/lite-1.072.html`, { waitUntil: 'domcontentloaded' });
  ...
  await pg7.goto(`http://localhost:${port}/lite-1.072.html`, { waitUntil: 'domcontentloaded' });
  ...
  await pg7x.goto(`http://localhost:${port}/lite-1.072.html?share=ABC`, { waitUntil: 'domcontentloaded' });
  ...
  await pg8x.goto(`http://localhost:${port}/lite-1.072.html?share=ABC`, { waitUntil: 'domcontentloaded' });
  ...
  await pg8bx.goto(`http://localhost:${port}/lite-1.072.html`, { waitUntil: 'domcontentloaded' });
  ...
  await pg8.goto(`http://localhost:${port}/lite-1.072.html?share=ZZZ`, { waitUntil: 'domcontentloaded' });
  ...
  await pg8miss.goto(`http://localhost:${port}/lite-1.072.html?share=NOPE`, { waitUntil: 'domcontentloaded' });
  ...
  await pg9.goto(`http://localhost:${port}/lite-1.072.html`, { waitUntil: 'domcontentloaded' });
  ...
  await pg9b.goto(`http://localhost:${port}/lite-1.072.html`, { waitUntil: 'domcontentloaded' });
  ...
  await pg10.goto(`http://localhost:${port}/lite-1.072.html?share=ZZZ`, { waitUntil: 'domcontentloaded' });
  ...
  await pgL.goto(`http://localhost:${port}/lite-1.072.html`, { waitUntil: 'domcontentloaded' });
