...
await p.evaluate(()=>{_openSongObj({id:'S',title:'My Song',key:'C major',lyricsDoc:'<div>I walked the line for you</div>'});stopTakesListener();
  document.getElementById('playBtn').classList.remove('disabled');
  document.getElementById('recTimer').textContent='0:08';});
await p.waitForTimeout(150);
await p.screenshot({path:'_shot_rail4.png'});
